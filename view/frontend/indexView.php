...
<div class="container">
    <div class="row">
        ...
        if (isset($_SESSION['adminLogged']) && $_SESSION['adminLogged']) {
            ...
            <em><a href="index.php?action=addChapterView" class="linkAdmin">ajouter un chapitre</a></em><br />
            <em><a href="index.php?action=showAllReportedComment" class="linkAdmin">administrer les commentaires reported</a></em>
            <?php
        }
        ?>
